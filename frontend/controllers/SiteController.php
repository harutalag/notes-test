...
use frontend\models\search\NotesSearchMain;
...
class SiteController extends Controller
{
    ...
    {
        $searchModel = new NotesSearchMain();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionViewUserNote($id)
    {
        if (($model = Notes::findAll(['user_id' => $id])) !== null) {
            return $this->render('note-user-view', [
                'model' => $model,
            ]);
        }
